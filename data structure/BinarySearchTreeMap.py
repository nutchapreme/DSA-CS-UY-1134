    ...
    def delete_node(self, node_to_delete):
        ...
        if(node_to_delete is self.root):
            ...
            if(num_children == 0):
                ...
                node_to_delete.total_children -= 1
            
            while (curr is not None):
                curr.total_children -= 1
                curr = curr.parent
    ...
    def get_ith_smallest(self, ind):
        ...
        def ith_smallest_helper(root,i):
            ...
            if root.left is None:
                if i == 1: return root.item.key
                return ith_smallest_helper(root.right, i-1)
            if i<= (root.left.total_children + 1):
                return ith_smallest_helper(root.left, i)
            elif i == root.left.total_children + 2:
                return root.item.key
            else:
                return ith_smallest_helper(root.right, i-root.left.total_children -2)
    
        return ith_smallest_helper(self.root, ind)