...
class LinkedBinaryTree:
    ...
    def leaves_list(self):
        ...
        return [item for item in subtree_leaves_list(self.root)]
    ...
    def iterative_inorder(self):
        ...
        while cursor is not None:
            ...
            yield cursor.data
            # CHECK RIGHT, IF RIGHT GO DOWN THEN ALL THE WAY LEFT
            if cursor.right:
                cursor = cursor.right
                while cursor.left:
                    cursor = cursor.left
            # IF NOT RIGHT, TRAVEL UP AS LONG AS CURSOR IS RIGHT CHILD TO PREVENT DOUBLE YIELD
            else:
                while cursor.parent and (cursor is cursor.parent.right):
