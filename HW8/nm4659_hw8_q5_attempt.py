class BinarySearchTreeMap:
    ...
    def get_ith_smallest(self,i):
        ...
        def get_ith_subtree(node,i):
            left_size=node.left.size if node.left else 0
            if i==left_size+1:
                return node
            elif i<=left_size:
                return get_ith_subtree(node.left,i)
            else:
                return get_ith_subtree(node.right,i-left_size-1)
        return get_ith_subtree(self.root,i).item.key
